...
if state == 1:
    ...
    worksheet_fan_variation.write("A1", 'Fan Speed Variation With habitual filter, full module, Air guide')
...
if state != 1:
    workbook = openpyxl.load_workbook('/home/zeinab/python_script/temperature_of_components_in_olt/workbook_test_2.xlsx')
    speed_fan_set = 40
    for fan_index in range(1,5):
        fan_speed = set_and_get_fan_speed(snmp_interface, sinaSP5100FanSpeed, speed_fan_set, shelfIndex, fan_index)               
    if state == 2:
